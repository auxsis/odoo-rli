...
class pos_config(models.Model):
    ...
    allow_lock_screen = fields.Boolean('Lock screen',
                                       default=0,
                                       help='When pos sessions start, cashiers required open POS via pos pass pin (Setting/Users)')
    ...
    print_voucher = fields.Boolean('Create vouchers', help='Allow cashiers create voucher', default=0)
    scan_voucher = fields.Boolean('Scan voucher', help='Allow cashiers scan vouchers of customers', default=0)
    ...
    sync_session_turn_on_dialog = fields.Boolean('Turn on dialog', help='If checked, pos auto turn on dialog when sync sessions')
    ...
    add_customer_before_products_already_in_shopping_cart = fields.Boolean('Required add client first', help='Add customer before products already in shopping cart', default=0)
    ...
    sale_package = fields.Boolean('Sale package')
