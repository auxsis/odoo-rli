odoo.define('pos_retail.report', function (require) {
    ...
    var button_report_product_summary = screens.ActionButtonWidget.extend({
        template: 'button_report_product_summary',
        button_click: function () {
            this.gui.show_popup('popup_report_product_summary');
        },
    });
    screens.define_action_button({
        'name': 'button_report_product_summary',
        'widget': button_report_product_summary,
        'condition': function () {
            return this.pos.config.report_product_summary;
        },
    });

    var button_report_order_summary = screens.ActionButtonWidget.extend({
        template: 'button_report_order_summary',
        button_click: function () {
            this.gui.show_popup('popup_report_order_summary');
        },
    });
    screens.define_action_button({
        'name': 'button_report_order_summary',
        'widget': button_report_order_summary,
        'condition': function () {
            return this.pos.config.report_order_summary;
        },
    });

    var button_report_payment_summary = screens.ActionButtonWidget.extend({
        template: 'button_report_payment_summary',
        button_click: function () {
            this.gui.show_popup('popup_report_payment_summary');
        },
    });
    screens.define_action_button({
        'name': 'button_report_payment_summary',
        'widget': button_report_payment_summary,
        'condition': function () {
            return this.pos.config.report_payment_summary;
        },
    });
